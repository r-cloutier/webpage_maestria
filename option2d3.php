<br><br>
<p style="font-size:24px" align="left">&nbsp;&nbsp;&nbsp;<b>Option 2.3</b><span style="font-size:18px">: set the effective RV rms verbatim</span></p>&nbsp;&nbsp;&nbsp;
...
<table>
	...
	<tr>
		...
		value="<?php echo isset($_GET['mp']) ? $_GET['mp'] : $mp ?>"  size="10" maxlength="50" onkeypress="return noenter()"/></td>
        </tr>
</table>
...
<table>
	<tr>                
		...
		isset($_GET['sigRVeff']) ? $_GET['sigRVeff'] : $sigRVeff ?>"  size="10" maxlength="50" onkeypress="return noenter()"/><b> &#42;</b>
