...
<table>
	...
	<tr>
		...
		onkeyup="stellar_magnitude()" value="<?php echo $wlminin ?>" size="10" maxlength="50" onkeypress="return noenter()"/><b> &#42;</b>
		...
		onkeyup="stellar_magnitude()" value="<?php echo $wlmaxin ?>" size="10" maxlength="50" onkeypress="return noenter()"/><b> &#42;</b>
...
-->
			...
			<span class="error"><?php echo ($vsiniErr!=NULL) ? $vsiniErr : "" ?></span></td>
                        <?php if ($_GET['NGPtrials']>0) : ?>
                                ...
                                maxlength="50" onkeypress="return noenter()"/><b> &#42;</b>
...
<table>
		...
		echo isset($_GET['sigRVact']) ? $_GET['sigRVact'] : $sigRVact ?>"  size="10" maxlength="50" onkeypress="return noenter()"/> <b>&#42;</b>
